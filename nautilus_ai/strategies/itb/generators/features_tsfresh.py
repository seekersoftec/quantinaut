# generators/features_tsfresh.py

from nautilus_ai.strategies.itb.generators.generator import Generator, register_generator
from nautilus_ai.strategies.itb.generators.utils import _aggregate_last_rows


@register_generator("tsfresh")
class TSFresh(Generator):
    """
    ...
    def generate(self, df, last_rows=0, **kwargs):
        return _tsfresh(df, self.config, last_rows)



def _tsfresh(df, config: dict, last_rows: int = 0):
    """
    This feature generator relies on tsfresh functions.
